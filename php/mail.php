 ...
 * ===================================================== */
$email_to = "andruambia95@gmail.com";
$email_from = "mpec@edu.org"; // must be different than $email_from
...
if(isset($_POST['email']))
{
    ...
    {
        echo json_encode(array('success'=>0, 'message'=>'An error occured. Please check your Internet connection and try again.'));
        die();
    }
}
else
